...
# with command line options: --python_filename theConfigFile.py --eventcontent MINIAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier MINIAODSIM --fileout file:SUS-RunIISummer20UL18MiniAOD-00069.root --conditions 106X_upgrade2018_realistic_v11_L1v1 --step PAT --geometry DB:Extended --filein dbs:/SMS-T2tt-4bd_genMET-100_genHT200_mStop-300_mLSP-290_TuneCP5_LLStop_13TeV-madgraphMLM-pythia8/RunIISummer20UL18RECO-106X_upgrade2018_realistic_v11_L1v1-v1/AODSIM --era Run2_2018 --runUnscheduled --no_exec --mc -n 100
...
process = cms.Process('customMiniAOD',Run2_2018) # Run2_2018 is passed as a modifier
...
output_mod = cms.OutputModule("PoolOutputModule",
    fileName = cms.untracked.string('file:/users/alikaan.gueven/AOD_to_nanoAOD/data/SUS-RunIISummer20UL18MiniAOD-00069.root'),
    ...
    outputCommands = process.MINIAODSIMEventContent.outputCommands, # this is cms.untracked.vstring
...
# # Additional output definitions for Ang's vtxreco
...
# # Preparing Ang's output definitions
...
# Defining unscheduled executions (lazy evaluation)
