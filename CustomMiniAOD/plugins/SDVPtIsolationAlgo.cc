#ifndef SDVPtIsolationAlgo_h
#define SDVPtIsolationAlgo_h
...
class SDVPtIsolationAlgo {
public:
  typedef double value_type;
  SDVPtIsolationAlgo() { }
  SDVPtIsolationAlgo( double dRMin, double dRMax, double dzMax,
...
template <typename T, typename C>
double SDVPtIsolationAlgo<T, C>::operator()(const T & cand, const C & elements) const {
  double ptSum = 0;
