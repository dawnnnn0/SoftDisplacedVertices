...
# with command line options: NANO -s NANO --python_filename Data_UL16preVFP_CustomNanoAOD.py --filein file:MiniAOD.root --fileout NanoAOD.root --data --conditions 106X_dataRun2_v35 --era Run2_2016_HIPM,run2_nanoAOD_106Xv2 --eventcontent NANOAOD --datatier NANOAOD --customise_commands=process.add_(cms.Service('InitRootHandlers', EnableIMT = cms.untracked.bool(False)));process.MessageLogger.cerr.FwkReport.reportEvery=1000 --customise SoftDisplacedVertices/CustomNanoAOD/nanoAOD_cff.nanoAOD_customise_SoftDisplacedVertices -n -1 --no_exec --nThreads 4
