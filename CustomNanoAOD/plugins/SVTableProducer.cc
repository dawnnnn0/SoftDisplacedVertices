...
class SVTableProducer : public edm::stream::EDProducer<> {
public:
  explicit SVTableProducer(const edm::ParameterSet&);
  ~SVTableProducer() override;
...
//
SVTableProducer::SVTableProducer(const edm::ParameterSet& params)
...
SVTableProducer::~SVTableProducer() {
...
void SVTableProducer::produce(edm::Event& iEvent, const edm::EventSetup& iSetup) {
  using namespace edm;
  ...
  auto selCandSv = std::make_unique<std::vector<reco::Vertex>>();
...
void SVTableProducer::beginStream(edm::StreamID) {}

// ------------ method called once each stream after processing all runs, lumis and events  ------------
void SVTableProducer::endStream() {}

// ------------ method fills 'descriptions' with the allowed parameters for the module  ------------
void SVTableProducer::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
